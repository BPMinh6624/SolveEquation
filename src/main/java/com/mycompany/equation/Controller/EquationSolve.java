 ...
 */
package com.mycompany.equation.Controller;

import com.mycompany.equation.Common.Library;
import com.mycompany.equation.Model.EquationModel;
import com.mycompany.equation.View.Menu;
 ...
 * @author tuanh
 */
public class EquationSolve extends Menu<String> {
   static String[] mc = {"Calculate Superlative Equation", "Calculate Quadratic Equation","Exit"};
    ...
    public EquationSolve (EquationModel equationModel) {
